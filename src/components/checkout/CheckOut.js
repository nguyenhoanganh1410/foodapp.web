                ...
                <div className="content_left col-6 col-sm-12">
                    <div className='checkout-progress'>
                        <div className='checkout-progress__node active'>
                           <div className='checkout-progress__icon'><FaUsers /></div>
                            <span className='checkout-progress__description'>Login</span>
                        </div>
                        <div className='checkout-progress__line active_line'></div>
                        <div className='checkout-progress__node active'>
                           <div className='checkout-progress__icon'><MdConfirmationNumber /></div>
                        ...
                        <div className='checkout-progress__node'>
                           <div className='checkout-progress__icon'><AiOutlineLike /></div>
                    ...
                    <div className='checkout-form'>
                        ...
                        <div className='form-btns'>
                            <div className='return-to-shop'>
                                <div className='arrow'><MdKeyboardArrowLeft /></div>
                ...
                <div className="content_right col-6 col-sm-12">
                    <ul className='content_product'>
                        <li>
                           <div className='li_product'>
                            <div className='product_img'><img src={iteam} /></div>
                                <div className='product_content'>
                                <span className='product_name'>Lou Malnati's Pizza</span>
                                <span className='product_address'>New Orleans, LA</span>
                            </div>
                           </div>
                            <div className='product_price'>$89</div>
                        </li>
                    </ul>
                    ...
                    <div className='checkout-detail'>
                         <div className='checkout-detail_row'>
                            ...
                            <span className='detail_price'>$99.00</span>
                         </div>
                         <div className='checkout-detail_row'>
                    ...
                    <div className='checkout-total'>
                        ...
                        <span className='total_price'>$99.00</span>
                    </div>
